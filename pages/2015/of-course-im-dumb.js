...
export default () => (
  <Post>
    ...
    <P>{`"`}Are you stupid?{`"`} — Well, in some cases, I am. In some
    others, I{`'`}m not. But I definitely know that you
    are. Why? Because you{`'`}re asking me such a dumb question.</P>

    <P>If a person is {`"`}dumb{`"`} or not, depends on the intellect of the
    ...
    context, you{`'`}re the dumb one.</P>

    <P>So now tell me, how should I know by myself if I{`'`}m dumb or
    ...
    question, you don{`'`}t. Therefore I{`'`}m free to call you dumb.</P>

    <HR/>

    <P>If someone asks you if you{`'`}re dumb, you{`'`}re free to use the first
    paragraph as an answer. But beware: If the person who{`'`}s asking
    you is smart enough, she will answer with {`"`}It{`'`}s a
    rhetorical question, you moron.{`"`}</P>
  </Post>
)
